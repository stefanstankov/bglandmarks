	 ...
	 <div id="myCarousel" class="carousel slide" data-ride="carousel">
		 ...
		 <div class="carousel-inner" role="listbox">
			 <div class="item active">
				 <img class="first-slide" src="../assets/img/5.jpg" alt="First slide">
			 </div>
			 <div class="item">
				 <img class="second-slide" src="../assets/img/4.ijpg" alt="Second slide">
			 </div>
			 <div class="item">
				 <img class="third-slide" src="../assets/img/8.jpg" alt="Third slide">
			 </div>
		 </div>
