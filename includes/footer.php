  <footer>
    <hr/>
      <p><span id="f-name">&copy; Bulgarian landmarks<span> <a rel="tooltip" title="Харесайте ни във Facebook" data-placement="bottom" href="https://www.facebook.com/" target="_blank" class="btn btn-white btn-simple btn-just-icon">
