...
define('STATUE_SHORT', '<p class="text-left"><strong>Местоположение</strong> - на входа на град Кърджал...</p>');
...
define('SWAN_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед...</p>');
