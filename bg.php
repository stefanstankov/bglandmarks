...
define('ABOUT_BG', '<p class="text-left aboutbg">Република България е държава в Югоизточна Европа, в източната част на Балканския полуостров и заема 23% от неговата територия. Граничи на север с Румъния; на запад със Сърбия и Република Македония; на юг с Гърция и на югоизток с Турция. На изток, по протежение на бреговата ивица, страната се мие от водите на Черно море.</p> <p class="text-left aboutbg">Със своите почти 111 хил. km² площ и 7,153 милиона души, България се подрежда на 11-о и 16-о място съответно по площ и по население в Европейския съюз.</p>');
define('USTRA_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Наименование на обекта</strong> - Средновековна крепост Устра, археологически паметник с национално значение.</p>
...
<p class="text-left">В основата дебелина е 2.8м, а в горния край - 1.75м. На места е запазена до височина 8.0м. Крепостта е имала 3 отбранителни кули - една полукръгла и две правоъгълни, които са били триетажни. Първите етажи са били подземни и са служили за водохранилища. Били са измазани с хоросанова мазилка, получена от смесването на хоросан със счукани тухли и едри късове от керамика. Кулите са имали стълбища, като част от тях са запазени и до днес. Входът е бил от източната част. Вратата се отваряла вертикално.</p></blockquote>');
define('PERPERIKON_ARTICLE', '<blockquote class="text-color"><p class="text-left">Паметник на културата с национално значение</p>
...
<p class="text-left">Дяволският мост е знаков за малкото родопско градче. Жителите на гр.Ардино са го патентовали като герб на населеното място.</p></blockquote>');
define('DAM_ARTICLE', '<blockquote><p class="text-left">Язовир "Кърджали" е един от трите големи язовира, заедно с язовир "Студен кладенец" и "Ивайловград", които акумулират водите на река Арда и нейните притоци</p>
...
<p class="text-left">Експоцизията на музея се състои от три раздела - Археология, Природа и Етнография. За всеки един от тях е отделен по един етаж с отделни тематични зали.</p></blockquote>');
define('FOREST_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Наименование на обекта</strong> - Вкаменената гора, обявен за е за защитен обект в категория "природна забележителност".</p>
...
define('SWAN_VILLAGE_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед, природна забележителност.</p>
<p class="text-left"><strong>Местоположение</strong> - с.Лебед, общ.Джебел.</p>
<p class="text-left"><strong>Описание на обекта</strong> - в района на с.Лебед преди много години в резултат на разместване на земните пластове са се формирали две естествени тектонски езера с растящи в тях естествени колонии диви лилии. Мястото е красиво, в близост има борова гора, а на около 500м е подходът към средновековната крепост Устра.</p><blockquote>');
define('EAGLE_ROCKS_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Наименование на обекта</strong> - Тракийско скално светилище Орловите скали, паметник на културата с национално значение.</p>
...
<p class="text-left">Въпреки различните хипотези относно предназначението и датирането на трапецовидните ниши за сега тяхното тайно послание остава неразгадано В близост (на височината преди да се стигне до нишите), се забелязват руините на древна тракийска крепост, известна като Калето</p></blockquote>');
define('MUSHROOMS_ARTICLE', '<blockquote class="text-color"> <p class="text-left"><strong>Местоположение</strong> - с.Бели пласт, община Кърджали.</p>
...
смисъл в геометричните размери, ориентация и морфология, изразени в основните й пространствени характеристики. С астрономическите ориентири са свързани най-значимите природни явления, от които зависи целия живот на човека, а следователно и всички определящи признаци на материалната и духовна култура на древното население.</p></blockquote>');
?>
