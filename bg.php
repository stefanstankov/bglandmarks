...
define('PERPERIKON_SHORT', '<p class="text-left">Паметник на културата с национално значение...</p>');
define('USTRA_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Средновековна крепост Устра, археологически паметник с национално значение...</p>');
define('BRIDGE_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Дяволски мост над р.Арда, архитектурен паметник с местно значение...</p>');
define('DAM_SHORT', '<p class="text-left">Язовир "Кърджали" е един от трите големи язовира, заедно с язовир...</p>');
define('STATUE_SHORT', '<p class="text-left"><strong>Местоположение</strong> - на входа на град Кърджали...</p>');
define('MUSEUM_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Регионален исторически музей...</p>');
define('FOREST_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Вкаменената гора, обявен за е за защитен обект в категория "природна забележителност"...</p>');
define('SWAN_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед, природна забележителност...</p>');
define('ROCKS_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Тракийско скално светилище Орловите скали, паметник на ...</p>');
define('STONE_SHORT', '<p class="text-left"><strong>Местоположение</strong> - с.Бели пласт, община Кърджали...</p>');
define('UTROBA_SHORT', '<p class="text-left"><strong>Местоположение</strong> - намира се в скалистата местност Тангардък кая до с.Ненково</p>...');
define('USTRA_ARTICLE', '<p class="text-left"><strong>Наименование на обекта</strong> - Средновековна крепост Устра, археологически паметник с национално значение.</p>
...
<p class="text-left">В основата дебелина е 2.8м, а в горния край - 1.75м. На места е запазена до височина 8.0м. Крепостта е имала 3 отбранителни кули - една полукръгла и две правоъгълни, които са били триетажни. Първите етажи са били подземни и са служили за водохранилища. Били са измазани с хоросанова мазилка, получена от смесването на хоросан със счукани тухли и едри късове от керамика. Кулите са имали стълбища, като част от тях са запазени и до днес. Входът е бил от източната част. Вратата се отваряла вертикално.</p>');
define('PERPERIKON_ARTICLE', '<p class="text-left">Паметник на културата с национално значение</p>
...
define('BRIDGE_ARTICLE', '<p class="text-left"><strong>Наименование на обекта</strong> - Дяволски мост над р.Арда, архитектурен паметник с местно значение.</p>
...
<p class="text-left">Дяволският мост е знаков за малкото родопско градче. Жителите на гр.Ардино са го патентовали като герб на населеното място.');
define('DAM_ARTICLE', '<p class="text-left">Язовир "Кърджали" е един от трите големи язовира, заедно с язовир "Студен кладенец" и "Ивайловград", които акумулират водите на река Арда и нейните притоци</p>
...
<p class="text-left">Експоцизията на музея се състои от три раздела - Археология, Природа и Етнография. За всеки един от тях е отделен по един етаж с отделни тематични зали.</p>');
define('FOREST_ARTICLE', '<p class="text-left"><strong>Наименование на обекта</strong> - Вкаменената гора, обявен за е за защитен обект в категория "природна забележителност".</p>
...
define('SWAN_VILLAGE_ARTICLE', '<p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед, природна забележителност.</p>
<p class="text-left"><strong>Местоположение</strong> - с.Лебед, общ.Джебел.</p>
<p class="text-left"><strong>Описание на обекта</strong> - в района на с.Лебед преди много години в резултат на разместване на земните пластове са се формирали две естествени тектонски езера с растящи в тях естествени колонии диви лилии. Мястото е красиво, в близост има борова гора, а на около 500м е подходът към средновековната крепост Устра.</p>');
define('EAGLE_ROCKS_ARTICLE', '<p class="text-left"><strong>Наименование на обекта</strong> - Тракийско скално светилище Орловите скали, паметник на културата с национално значение.</p>
<p class="text-left"><strong>Достъп до обекта</strong> - намира се на 2,1 км. южно от общинският център гр.Ардино. До самото светилище е изградена екопътека, която е
добре маркирана и обозначена, по протежение на самата екопътека е изградена беседка и чешма с питейна вода.</p>
<p class="text-left"><strong>Описание на обекта</strong> - тракийско скално светилище Орлови скали е разположено в землището на град Ардино. Орловите скали са група
изявени вулканични скали. Местоположението им е върху силно наклонен планински теренс надморска височина около 760м. Разположени са на склон със западно изложение. Височината на скалите достига до 25м от околоният терен. На недостъпни места в скалите са изсечени от човешка ръка трапецовидни ниши, от които сега са запазени 97. Най-много - 55 се намират на западната страна. Пет-шест от тях са разрушени от атмосферните условия, а можеби не са довършени. От южната страна те са 35, от северната-5, от източната която не е достъпна, им 5-6 разрушени. Скалните трапецовидни ниши са един от културните феномени на древността от Източните Родопи. Те са най-монументалните, но й най-странни и необясними родопски паметници. Разпространени са във водосборния басейн на река Арда, по средното й течение заедно с други скални мегалитни паметници, като скалните гробници и гробове и скалните светилища. Те винаги са издълбани на голяма височина върху отвесните стени на видни отдалеч канари и масиви, предимно на огряната от слънцето страна, образувайки грандиозни ансамбли</p>
<p class="text-left">Въпреки различните хипотези относно предназначението и датирането на трапецовидните ниши за сега тяхното тайно послание остава неразгадано В близост (на височината преди да се стигне до нишите), се забелязват руините на древна тракийска крепост, известна като Калето</p>');
