...
define('INSTA', 'От страницата ни в инстраграм');
...
define('ABOUT_BG', '<p class="text-left"><strong>Република България</strong> е държава в Югоизточна Европа, в източната част на Балканския полуостров и заема 23% от неговата територия. Граничи на север с Румъния; на запад със Сърбия и Република Македония; на юг с Гърция и на югоизток с Турция. На изток, по протежение на бреговата ивица, страната се мие от водите на Черно море.</p> <p class="text-left">Със своите почти 111 хил. km² площ и 7,153 милиона души, България се подрежда на 11-о и 16-о място съответно по площ и по население в Европейския съюз.</p>');
define('USTRA_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - Средновековна крепост Устра, археологически паметник с национално значение.</p>
...
define('PERPERIKON_ARTICLE', '<blockquote><p class="text-left">Паметник на културата с национално значение</p>
...
define('BRIDGE_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - Дяволски мост над р.Арда, архитектурен паметник с местно значение.</p>
...
define('STATUE_ARTICLE', '<blockquote><p class="text-left"><strong>Местоположение</strong> - на входа на град Кърджали</p>
...
define('MUSEUM_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - Регионален исторически музей.</p>
...
define('FOREST_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - Вкаменената гора, обявен за е за защитен обект в категория "природна забележителност".</p>
...
define('SWAN_VILLAGE_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед, природна забележителност.</p>
...
define('EAGLE_ROCKS_ARTICLE', '<blockquote><p class="text-left"><strong>Наименование на обекта</strong> - Тракийско скално светилище Орловите скали, паметник на културата с национално значение.</p>
...
define('MUSHROOMS_ARTICLE', '<blockquote> <p class="text-left"><strong>Местоположение</strong> - с.Бели пласт, община Кърджали.</p>
...
define('UTROBA_ARTICLE', '<blockquote>
