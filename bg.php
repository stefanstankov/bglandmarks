...
define('USTRA_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Средновековна крепост Устра...</p>');
define('BRIDGE_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Дяволски мост над р.Арда...</p>');
define('DAM_SHORT', '<p class="text-left">Язовир "Кърджали" е един от трите...</p>');
define('STATUE_SHORT', '<p class="text-left"><strong>Местоположение</strong> - на входа на град Кърджали...</p>');
define('MUSEUM_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Регионален исторически...</p>');
define('FOREST_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Вкаменената гора, обявен...</p>');
define('SWAN_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - езерата край с.Лебед, природна...</p>');
define('ROCKS_SHORT', '<p class="text-left"><strong>Наименование на обекта</strong> - Тракийско скално светилище...</p>');
define('STONE_SHORT', '<p class="text-left"><strong>Местоположение</strong> - с.Бели пласт, община Кърджали <p class="text-left"><strong>Достъпност до обекта</strong> - леснодостъпен...</p>');
define('UTROBA_SHORT', '<p class="text-left"><strong>Местоположение</strong> - намира се в скалистата местност...</p>');
