	...
	<div class="container panel1">
		<div class="panel panel-default panel-article">
			<div class="panel-heading">
					<h2><span class="text-color1"><?= EAGLE_ROCKS;?></span><span class="pull-right"><a class="text-color1" href="javascript:history.go(-1)"><i class="fa fa-times" aria-hidden="true"></i></a></span></h2>
				</div>
