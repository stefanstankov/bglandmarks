<?php
define('EDITORS_CHOISE', '<p class="text-color">Autor\'s choice</p>');
define('HOME', 'Home');
define('CATEGORIES', 'Categories');
define('LANDMARKS', 'Landmarks');
define('NATURAL', '<p class="text-color">Natural</p>');
define('HISTORICAL', '<p class="text-color">Historical</p>');
define('ARCHITECTURAL', '<p class="text-color">Arhitectural</p>');
...
define('LOCATION', '<p class="text-color">Location</p>');
define('FROM_CATEGORY', 'From the category');
define('LANDMARK_NAME', 'Landmarks');
define('RANDOM_PICS', '<p class="text-color">From YouTube</p>');
define('LINKS', 'Links');
define('QL', 'Quick Links');
define('INSTA', '<p class="text-color">From our instagram feed</p>');
...
define('USTRA_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Name of site</strong> - Ustra Medieval Fortress, an archeological monument of national importance.</p>
...
define('BRIDGE_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Name of site</strong> - the Devils Bridge over the Arda River, a monument of national importance.</p>
...
<p class="text-left">The Devils Bridge is a landmark for the small Rhodope town. Residents of Ardino have patented it as an amblem of the settlement.</p></blockquote>');
define('DAM_ARTICLE', '<blockquote class="text-color"><p class="text-left">Kardzhali dam, along with Ivaylovgrad dam and Studen Kladenets dam are the three biggest ones that accumulate the Arda River and its tributaries.</p>
...
<p class="text-left">In summer, the dam serves as a means of recreation for both residents of, and visitors to, Kardzhali. It is a popular place among fans of water sports. Hotels, open-air restaurants and summer houses are built in proximity.</p></blockquote>');
define('STATUE_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Location</strong> - at entrance of the town of Kardzhali</p>
<p class="text-left"><strong>Description of site</strong> - At the very entrance of the town of Kardzhali, coming down from the towns of Haskovo and Plovdiv, majestic stands the statue of Orpheus - the ancient Greek mythical Thracian singer - the symbol of the Eastern Rhodope and the town of Kardzhali, and according to the myths and legends, he was born, raised and created art here. Before being placed at the entrance of the town of Kardzhali, the monument loomed large near the village of Panichkovo, but it was bent in the knees in an attempt of theft. At the same time, the idea comes to mind for the brass statue to be moved to a secured location. Not long after taking a short survey, Orpheus takes its place at the entrance of the town of Kardzhali. The unveiling of the statue was in June, 2005. The initiative to be restored and moved, after beeing demolished, at that location was one of "Rotary Club-Kardzhali". Krum Damyanov is its sculptor. A special platform and stairs for easy access were built around the monument. The statue is being lit at night and is even more beautiful. The statue of Orpheus in Kardzhali greets and sends off the visitors of the town!</p></blockquote>');
define('MUSEUM_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Location</strong> - Republicanska Str.№4, Kardzhali.</p>
...
<p class="text-left">Despite the numerous suggestions regarding their use and date of origin, their secret message remains unrevealed. The ruins of an ancient Thracian fortress known as the Kaleto can be seen nearby (at the height before you reach the niches).</p></blockquote>');
define('MUSHROOMS_ARTICLE', '<blockquote class="text-color"><p class="text-left"><strong>Location</strong> - village of Beli Plast, Kardzhali district.</p>
...
weather. So it took thousands of years to shape this wonderful combination of unique shapes and colors.</p></blockquote>');
