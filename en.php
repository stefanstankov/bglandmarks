...
define('ABOUT_BG', '<p class="text-left"><strong>Republic of Bulgaria</strong> is a country in southeastern Europe , in the eastern part of the Balkan Peninsula and occupies 23% of its territory. Bordered on the north by Romania ; on the west by Serbia and Macedonia ; south to Greece and to the southeast of Turkey . To the east, along the coastline, the country is washed by the waters of the Black Sea .</p> <p class="text-left">With almost 111 thousand. Km² respectively area and 7.4 million people, Bulgaria ranks 11th and 16th place respectively in area and population in the European Union.Most commercial and cultural activities are centred on the capital and largest city, Sofia. The strongest sectors of the economy are heavy industry, power engineering, and agriculture, all of which rely on local natural resources.</p></blockquote>');
define('PERPERIKON_ARTICLE', '<blockquote><p class="text-left">Monument of national importance</p>
...
define('USTRA_ARTICLE', '<blockquote><p class="text-left"><strong>Name of site</strong> - Ustra Medieval Fortress, an archeological monument of national importance.</p>
...
define('BRIDGE_ARTICLE', '<blockquote><p class="text-left"><strong>Name of site</strong> - the Devils Bridge over the Arda River, a monument of national importance.</p>
...
define('DAM_ARTICLE', '<blockquote><p class="text-left">Kardzhali dam, along with Ivaylovgrad dam and Studen Kladenets dam are the three biggest ones that accumulate the Arda River and its tributaries.</p>
...
define('STATUE_ARTICLE', '<blockquote><p class="text-left"><strong>Location</strong> - at entrance of the town of Kardzhali</p>
...
define('MUSEUM_ARTICLE', '<blockquote><p class="text-left"><strong>Location</strong> - Republicanska Str.№4, Kardzhali.</p>
...
define('FOREST_ARTICLE', '<blockquote><p class="text-left"><strong>Name of site</strong> - The Petrified Forest, declared a protected landmark.</p>
...
define('EAGLE_ROCKS_ARTICLE', '<blockquote><p class="text-left"><strong>Name of site</strong> - Orlovi skali Thracian sanctuary is a cultural monument of national importance.</p>
...
define('MUSHROOMS_ARTICLE', '<blockquote><p class="text-left"><strong>Location</strong> - village of Beli Plast, Kardzhali district.</p>
...
define('UTROBA_ARTICLE', '<blockquote><p class="text-left"><strong>Location</strong> - it is situated in the rocky area of Tangradak Kaya, close to to Nenkovo village, 20 kilometres away from Kardzhali.</p>
