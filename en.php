...
define('MUSHROOMS_ARTICLE', '<strong>Location</strong> - village of Beli Plast, Kardzhali district.<br>
<strong>Accessibility of site</strong> - easily accessible, located near the main road of Haskovo, shortly after the village of Beli Plast. It is fenced and has
signs and information boards.<br> There are regular buses Kardzhali - Haskovo through Beli Plast.<br>
...
weather. So it took thousands of years to shape this wonderful combination of unique shapes and colors.');
define('UTROBA_ARTICLE', '<strong>Location</strong> - it is situated in the rocky area of Tangradak Kaya, close to to Nenkovo village, 20 kilometres away from Kardzhali.
<strong>Accessibility of site</strong> - To reach the cave, a visitors should make a return from the road Kardzhali - Haskovo towards Padartsi and Dazhdovnitsa villages. Following a scenic
...
Public transportation - There is a regular bus line from Kardzhali to Nenkovo village.<br>
