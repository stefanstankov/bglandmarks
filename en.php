...
define('ABOUT_US_MESSAGE', '
This site is under development. Please anyone who wants to help send us pictures of the landmarks of the area in which he lives. Thank you!');
define('ABOUT_BG', 'Republic of Bulgaria is a country in southeastern Europe , in the eastern part of the Balkan Peninsula and occupies 23% of its territory. Bordered on the north by Romania ; on the west by Serbia and Macedonia ; south to Greece and to the southeast of Turkey . To the east, along the coastline, the country is washed by the waters of the Black Sea . With almost 111 thousand. Km² respectively area and 7.153 million people, Bulgaria ranks 11 O and 16 O place respectively in area and population in the European Union');
...
define('MUSEUM_ARTICLE', '<p class="text-left"><strong>Location</strong> - Republicanska Str.№4, Kardzhali.</p>
